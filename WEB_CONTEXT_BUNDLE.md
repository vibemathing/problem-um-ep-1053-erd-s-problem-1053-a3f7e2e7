...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1053-erd-s-problem-1053-a3f7e2e7-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1053"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1053-erd-s-problem-1053-a3f7e2e7-v1",
      "problem_contract_sha256": "9048eb2a6e0191522a8bc0f4f9ec643eb9b432b020210e484e39058bf8351773",
      "problem_id": "problem:um-ep-1053-erd-s-problem-1053-a3f7e2e7",
      "route_id": "route:um-ep-1053-erd-s-problem-1053-a3f7e2e7-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1053-erd-s-problem-1053-a3f7e2e7-source-fidelity-01",
      "graph_id": "graph:um-ep-1053-erd-s-problem-1053-a3f7e2e7-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1053-erd-s-problem-1053-a3f7e2e7-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1053-erd-s-problem-1053-a3f7e2e7-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Call a number $k$-perfect if $\\sigma(n)=kn$, where $\\sigma(n)$ is the sum of the divisors of $n$. Must $k=o(\\log\\log n)$?"
          },
          "statement_sha256": "30e4f2e87604f8b2d2a3b44ff4acd13bfc3bdbe03e56f5fced8eaa8930bfefde"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1053-erd-s-problem-1053-a3f7e2e7-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1053-erd-s-problem-1053-a3f7e2e7-root",
      "route_id": "route:um-ep-1053-erd-s-problem-1053-a3f7e2e7-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1053-ce18f465b808",
        "url": "https://www.unsolvedmath.com/problems/EP-1053"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
